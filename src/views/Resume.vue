    ...
    <div ref="resumeBody" class="resume-body">
      ...
      <div class="experience">
        ...
        <h4>华为技术有限公司（2014.12 - 2017.12）</h4>
          <h5>平台类系统</h5>
          <li>Unicloud：内部变革项目，该系统支撑公司内部业务流程端到端打通，支撑华为运营商业务，支撑产品配置与报价。<br/>参与系统的前后端开发工作，前端使用 webix 框架，参与了前端配置引擎的预研开发工作，期间学习了规则引擎原理和相关的算法，开发了一个在前端编写规则进行产品配置的 Demo。</li>
          <br />
