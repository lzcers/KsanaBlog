  ...
  <div class="resume">
    <div ref="resumeBody" class="resume-body">
      ...
      <div class="skill">
        ...
        <li>HTML/CSS：能够编写语义化的 HTML 结构，了解 BEM 等 CSS 编写实践，能够编写模块化的 CSS，完成较复杂的布局，了解 Less、PostCSS 等预处理器的使用。</li>
        <br />
      ...
      <div class="experience">
        ...
        <h4>华为技术有限公司（2014.12 - 2017.12）</h4>
          <p>
            带领团队交付内部多个 MIS 项目，支撑存量经营、订单履行、研发物料管理，参与公司重大变革项目前端开发与技术预研，支撑公司内部业务流程端到端打通，支撑华为运营商业务，参与华为公有云产品研发。 
            <br />
            参与过华为首届黑客马拉松拿了二等奖，拿过华为明日之星奖，参与过 Scrum 等技能培训，担任过部门总体技术组的执行秘书，组织会议、技术分享、讨论等活动。
          </p>
          <h5>平台类项目</h5>
        ...
        <h4>Anker（湖南海翼电子商务股份有限公司）（2014.7 - 2014.9 实习）</h4>
